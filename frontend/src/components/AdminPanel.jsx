...
const AdminPanel = () => {
    ...
    const Links = [
        {name: "Dashboard", link: '/dashboard', icon: "fa-solid fa-table-columns"},
    ...
    return (
        <div className='h-screen relative'>
            ...
            <ul className={`md:pt-16 pt-20 pl-4 w-56 border-r h-full absolute md:static ${open ? 'left-0' : 'left-[-250px]'} duration-500`}>
            {
                Links.map((link) => (
